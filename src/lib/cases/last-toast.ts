...
export const lastToastCase: CaseFile = {
  ...
  evidence: [
    ...
    },
    {
      ...
      deduction:
        "Between 21:12 and 21:16 someone swapped the necklace — and the sleeve says it was not Elena alone in frame.",
      imageSrc: "/evidence/last-toast/cctv-916.svg",
      imageStamp: "21:16 · SAME ANGLE · NECKLACE GONE",
      visualTell: "Necklace gone + mismatched sleeve + lift reflection.",
      ...
      conceal: {
        label: "Check the sleeve seam",
        text: "The blue cuff in frame is not Elena’s gown fabric — it matches the plus-one’s jacket lining from coat check.",
      },
    },
    {
      id: "kitchen-ticket",
