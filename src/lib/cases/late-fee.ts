...
export const lateFeeCase: CaseFile = {
  ...
  number: 8,
  title: "The Late Fee",
  subtitle: "A courier pouch, two clocks, and a busker who weaponizes blame.",
  premise:
    "Harbor Street fair. Jules clipped cash to meter #441 for a taco run. By 15:07 the pouch was gone and Paz already had a novel about Rita. Problem: clocks don’t do fanfiction. Name who took it, how, and where it’s sweating now.",
  difficulty: "standard",
  unlockAfterCaseId: "pigeon-job",
  briefing: [
    {
      title: "THE SETUP",
      copy: "Mid-afternoon, Harbor Street fair. Jules Spoke trusts a parking meter more than people. The meter does not deserve it. The pouch vanishes; Paz’s storytelling arrives early.",
    },
    {
      title: "THE CLOCKS",
      copy: "Paz swears Rita ticketed #441 and walked off with black leather. Rita’s depot punch card says she was dating a time clock twelve minutes away. Someone is selling a false lead with jazz hands.",
    },
    {
      title: "YOUR JOB",
      copy: "Gather the fair cams, punch cards, and tip-jar still. One story can’t survive the clocks. Then Decide Who / How / Where and attach the proof that makes the liar’s version impossible.",
    },
  ],
  reconstruction: {
