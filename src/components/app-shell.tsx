  ...
  return (
    <TextScaleProvider>
      <div className="desk-stage relative min-h-dvh w-full">
        ...
        />
        <div className="relative mx-auto flex min-h-dvh w-full max-w-[430px] flex-col bg-[#EEF2F6] md:min-h-[min(100dvh,920px)] md:shadow-[0_24px_70px_rgba(27,36,48,0.22)] md:ring-1 md:ring-[#2F5BFF]/20">
